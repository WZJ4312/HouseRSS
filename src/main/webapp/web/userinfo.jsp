...
<div class="breadcrumbs">
    <div class="wrap"><a href="${ctx}/web/userinfo.jsp">首页</a> &gt; <a href="${ctx }/web/shop/userinfo">基本信息</a></div>
</div>
...
<script type="text/javascript"> 
	...
	function editPass() {
		...
		var url = "${ctx}/user/reset_password.do";
		$.ajax({
			url:url,
			type:'post',
			data:{
				passwordOld: $("#oldPassword").val().trim(),
				passwordNew:$("#newPassword").val().trim()
			},
			dataType:'text',
			timeout:60000,
			error: function(e) {
			...
			success: function(result){
                ...
                <div class="business-info-list">
                    ...
                    <div class="business-info-list-small">
                          <div class="business-info-list-small-list" style="display: none;">
...
<script type="text/javascript"> 
	...
	function edit_qq() {
		...
		var url = "${ctx}/user/update_information.do";
		$.ajax({
			url:url,
			type:'post',
			data:{
			...
			success: function(result){
				...
				alert(result.msg);
                          ...
                          <div class="business-info-list-small-list">
                            <div class="business-info-list-small-list-hd">
                              <span>手机</span>
                              <b id="user_phone_info">${currentUser.phone}</b>
...
<script type="text/javascript"> 
$(function(){
	$(".userinfo_dd").addClass("left_list_dd");
	if(!checkLogin()){
		return;
	}
