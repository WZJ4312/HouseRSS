...
<div class="breadcrumbs">
    <div class="wrap"><a href="${ctx}/web/userinfo.jsp">首页</a> &gt; <a href="#">被举报房源历史记录</a></div>
</div>
		...
		<div class="business-right">
          <div class="business-right-comm">
              <div class="business-info">
                <div class="integral-record-hd">被成功举报记录</div>
...
$(document).ready(function(){
	$(".report_records").addClass("left_list_dd");
	if(!checkLogin()){
		return;
	}
 	search(); 
...
var afterLoad = function(result){
	...
	for (var i = 0; i < result.data.data.length; i++) {
		...
		houseTmp = houseTmp.replace(/@@reportDate@@/g, result.data.data[i].reportDate);
...
function searchPage(page){
	...
	//其他参数
	postUrl("${ctx}/reportInfo/selectHouseReportInfo.do", paramJo, afterLoad)
}
