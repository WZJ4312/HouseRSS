...
<div class="breadcrumbs">
    <div class="wrap"><a href="${ctx}/web/userinfo.jsp">首页</a> &gt; <a href="#">举报用户管理</a></div>
</div>
		...
		<div class="business-right">
          <div class="business-right-comm">
              <div class="business-info">
                <div class="integral-record-hd">举报用户管理</div>
...
$(document).ready(function(){
	$(".complaint_user_list").addClass("left_list_dd");
	if(!checkLogin()){
		return;
	}
...
var afterLoad = function(result){
	...
	for (var i = 0; i < result.data.data.length; i++) {
		...
		houseTmp = houseTmp.replace(/@@reporteder@@/g, result.data.data[i].username);
...
function dealReport(id, type) {
	...
	<tbody id="complaint_user_tr">
		...
		<tr>
			...
			<td>@@description@@</td>
			<td>
				<a href="javascript:dealReport('@@id@@',1);" class="jx-trade eidt_button">封禁用户</a><br/>
